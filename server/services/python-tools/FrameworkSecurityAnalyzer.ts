/**
 * FrameworkSecurityAnalyzer - TypeScript Wrapper
...
export class FrameworkSecurityAnalyzerWrapper {
  ...
  constructor() {
    ...
    this._modulePath = path.join(
      process.cwd(),
      './tools/offsec-team/tools/bug_hunter/FrameworkSecurityAnalyzer.py'
    );
  }
...
# Create instance
tool = FrameworkSecurityAnalyzer()
 ...
 */
export function createFrameworkSecurityAnalyzer(): FrameworkSecurityAnalyzerWrapper {
  return new FrameworkSecurityAnalyzerWrapper();
}
