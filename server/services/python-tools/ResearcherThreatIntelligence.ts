/**
 * ResearcherThreatIntelligence - TypeScript Wrapper
...
export class ThreatIntelligenceRequestWrapper {
  ...
  constructor() {
    ...
    this._modulePath = path.join(
      process.cwd(),
      './tools/offsec-team/tools/bug_hunter/ResearcherThreatIntelligence.py'
    );
  }
...
from ResearcherThreatIntelligence import ThreatIntelligenceRequest

# Create instance
tool = ThreatIntelligenceRequest()
 ...
 */
export function createThreatIntelligenceRequest(): ThreatIntelligenceRequestWrapper {
  return new ThreatIntelligenceRequestWrapper();
}
