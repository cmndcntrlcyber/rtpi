...
description: Chrome DevTools — auto-generated stub
registry: mcp
tool_id: default:chrome-devtools
category: mcp-server
tags:
  - mcp-server
summary: "Chrome DevTools is a mcp-server registered in RTPI. No description
...
Chrome DevTools (no description provided).
